...
| 3  |Census data|Introduction to Neural Networks|Neural Networks|Model Validation|Assigment #1 (24%)|
| 4  |Satellite data|Earth Observation & Google Earth Engine|Land-use classification|Wildfire detection|Assigment #3 (12%)|
| 5  |Open-Source and VGI data|Working with OpenStreetMap|Flood Risk Assessment|Assigment #2 (12%)|
